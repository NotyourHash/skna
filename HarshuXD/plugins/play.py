...
from HarshuXD import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from HarshuXD.core.call import Aarohi
from HarshuXD.utils import seconds_to_min, time_to_seconds
from HarshuXD.utils.channelplay import get_channeplayCB
from HarshuXD.utils.database import is_video_allowed
...
from HarshuXD.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from HarshuXD.utils.inline.playlist import botplaylist_markup
...
@app.on_callback_query(
    filters.regex("AarohiymousAdmin") & ~BANNED_USERS
)
async def Aarohiymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(
    filters.regex("AarohiPlaylists") & ~BANNED_USERS
)
@languageCB
