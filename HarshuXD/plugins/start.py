...
from HarshuXD import Telegram, YouTube, app
from HarshuXD.misc import SUDOERS
from HarshuXD.plugins.playlist import del_plist_msg
from HarshuXD.plugins.sudoers import sudoers_list
from HarshuXD.utils.database import (add_served_chat,
                                       add_served_user,
                                       blacklisted_chats,
...
from HarshuXD.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgUAAxkBAAEHoY5l__0djAYm3aV-OOMv3YRhmH_t1AACNhMAAs8OAAFUohIjFXU5gFU0BA")
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/EquinoxBots) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
...
|| ᴍᴀᴅᴇ ᴡɪᴛʜ 🖤 ʙʏ [ʟᴏʀᴅ](https://t.me/Harshu_Huu) 🥀 ||
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="🍁•sᴜᴩᴩᴏʀᴛ[ʜᴇʟʟ]🍁•", url="https://t.me/EquinoxBots"
                        ),
                    ],
                ]
            )
