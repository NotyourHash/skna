...
from HarshuXD.utils.database import get_authuser_names, get_cmode
from HarshuXD.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Aarohi.stop_stream(message.chat.id)
    except:
        pass
